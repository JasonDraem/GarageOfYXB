...
@interface XXYPicScrollViewManager ()
@property (nonatomic,copy) NSString *cachePath;

@property (nonatomic,strong) NSMutableDictionary *DownloadImageCount;
@end

@implementation XXYPicScrollViewManager
+ (instancetype)shareManager {
    
    static XXYPicScrollViewManager *instance;
    
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[XXYPicScrollViewManager alloc] init];
    });
